...
const getUnit = (title: string) => {
  ...
  if (name.includes('water') || name.includes('juice') || name.includes('milk') || name.includes('drinks') || name.includes('ice cream') || name.includes('cooking oil') || name.includes('honey jar')) {
    return 'Liter';
